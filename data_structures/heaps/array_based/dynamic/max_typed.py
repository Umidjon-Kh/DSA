...
class DynamicTypedMaxHeap(BaseHeap):
    """
    A resizable max-heap backed by DynamicTypedArray.
    ...
    def __init__(
        ...
        *args,
        ...
        """
        Creates a resizable typed max-heap with optional initial elements.
        ...
        Examples:
            h = DynamicTypedMaxHeap(int)            # empty
            h = DynamicTypedMaxHeap(int, 1, 3, 5)   # root=5
        """
    ...
    def copy(self) -> "DynamicTypedMaxHeap":
        """
        Returns a shallow copy with the same dtype and elements.

        Time complexity: O(n)
        """
        new_heap = DynamicTypedMaxHeap(self._dtype, str_length=self._str_length)
    ...
    def __eq__(self, other: object) -> bool:
        ...
        """
        if not isinstance(other, DynamicTypedMaxHeap):
    ...
    def __repr__(self) -> str:
        ...
        Format: DynamicTypedMaxHeap(int, size=3)[5, 3, 1]
                                                  root
        ...
        return (
            f"DynamicTypedMaxHeap({self._dtype.__name__}, "
