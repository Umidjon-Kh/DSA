...
class StaticTypedMaxHeap(BaseBoundedHeap):
    """
    A fixed-capacity max-heap backed by StaticTypedArray.
    ...
    def __init__(
        ...
        *args,
        ...
        """
        Creates a fixed-capacity typed max-heap with optional initial elements.
        ...
        Examples:
            h = StaticTypedMaxHeap(int, capacity=5)           # empty, capacity=5
            h = StaticTypedMaxHeap(int, 5, 3, 1, capacity=5)  # root=5, capacity=5
        """
        self._dtype: type = dtype
        self._size: int = 0
        cap: int = validate_capacity(capacity, len(args), "StaticTypedMaxHeap")
    ...
    def copy(self) -> "StaticTypedMaxHeap":
        """
        Returns a shallow copy with the same dtype and capacity.

        Time complexity: O(n)
        """
        new_heap = StaticTypedMaxHeap(
    ...
    def __eq__(self, other: object) -> bool:
        ...
        """
        if not isinstance(other, StaticTypedMaxHeap):
    ...
    def __repr__(self) -> str:
        ...
        Format: StaticTypedMaxHeap(int, size=3, capacity=5)[1, 3, 2]
                                                              root
        ...
        return (
            f"StaticTypedMaxHeap({self._dtype.__name__}, "
